...
import { Home, Users, LogOut, User, Shield } from 'lucide-react';
...
export default function AdminSidebar({ isOpen = false, onClose }: AdminSidebarProps) {
  ...
  return (
    <aside 
      className={`fixed top-0 left-0 h-screen w-64 bg-white border-r border-gray-200 z-50 shadow-sm transition-transform duration-300 ease-in-out ${
